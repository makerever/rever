# Generated by Django 5.2.8 on 2025-12-22 18:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_type', models.CharField(choices=[('bill', 'Bill'), ('purchase_order', 'Purchase Order')], default='bill', max_length=50)),
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='document_extractions', to='db.organization')),
                ('purchase_order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='extractions', to='db.purchaseorder')),
