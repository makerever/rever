  ...
  const handleDisable = async () => {
    try {
      ...
      if (res?.status === 200) {
        ...
        showErrorToast(
          res?.data?.detail ||
          translate("approval_settings.cannot_disable"),
        );
      }
    } catch {
  ...
  return (
    <>
          ...
          <div className="w-fit flex items-start justify-between mb-6">
            ...
            <div className="ms-3 -mt-0.5">
              <p className="font-medium text-sm text-neutral-1100 dark:text-gray-200">
                {translate("approval_settings.bill_enable_label")}
              </p>
              <p className="mt-1 font-medium text-xs text-secondary-700 dark:text-gray-200">
                {translate("approval_settings.bill_enable_description")}
              </p>
            </div>
          </div>
      ...
      <ConfirmationPopup
        ...
        message={translate("approval_settings.disable_bill_message")}
      />
    </>
  );
};
