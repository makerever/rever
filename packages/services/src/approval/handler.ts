 ...
 */
export const getApprovalStatusApi = async () => {
  const response = await axiosInstance.get(APPROVAL_API.GET_APPROVAL);
  return response;
};
...
export const enableApprovalStatusApi = async (data: EnableApprovalProps) => {
  const response = await axiosInstance.post(APPROVAL_API.ENABLE_APPROVAL, data);
  return response;
};
 ...
 */
export const disableApprovalStatusApi = async () => {
  const response = await axiosInstance.delete(
    `${APPROVAL_API.DISABLE_APPROVAL}?model_name=bill`,
  );
  return response;
};
...
export const assignApproverApi = async (data: addApproverSchemaValues) => {
  const response = await axiosInstance.post(APPROVAL_API.ASSIGN_APPROVER, data);
  return response;
};
 ...
 */
export const getAssignApprovalApi = async () => {
  const response = await axiosInstance.get(
    `${APPROVAL_API.ASSIGN_APPROVER}?model_name=bill`,
  );
  return response;
};
